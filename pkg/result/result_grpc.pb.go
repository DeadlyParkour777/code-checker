...
const (
	ResultService_GetUserSubmissions_FullMethodName = "/result.ResultService/GetUserSubmissions"
)
...
func (c *resultServiceClient) GetUserSubmissions(ctx context.Context, in *GetUserSubmissionsRequest, opts ...grpc.CallOption) (*GetUserSubmissionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserSubmissionsResponse)
	err := c.cc.Invoke(ctx, ResultService_GetUserSubmissions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedResultServiceServer) GetUserSubmissions(context.Context, *GetUserSubmissionsRequest) (*GetUserSubmissionsResponse, error) {
...
func _ResultService_GetUserSubmissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserSubmissionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ResultServiceServer).GetUserSubmissions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ResultService_GetUserSubmissions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResultServiceServer).GetUserSubmissions(ctx, req.(*GetUserSubmissionsRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ResultService_GetUserSubmissions_Handler,
		},
	},
